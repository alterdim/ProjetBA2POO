...
public final class Trip {
     ...
     * @throws IllegalArgumentException Si le nombre de points est nul ou négatif.
     ...
     * @throws IllegalArgumentException si l'une des listes est vide ou si le nombre de point est nul ou négatif
     */
