...
//        System.out.println(ini.withoutTopCard());
    ...
    void withInitiallyChosenTickets(){
        ...
        assertEquals(0,ini.playerState(PLAYER_1).tickets().size());
...
//        System.out.println(ini.playerState(PlayerId.PLAYER_1).tickets().toList());
        ini=ini.withInitiallyChosenTickets(PLAYER_1, ticketsChosen);
//        System.out.println(ini.playerState(PlayerId.PLAYER_1).tickets().toList());

        assertEquals(ticketsChosen.size(),ini.playerState(PLAYER_1).tickets().size());

        GameState finalIni = ini;
        assertThrows(IllegalArgumentException.class, () -> {
            finalIni.withInitiallyChosenTickets(PLAYER_1, SortedBag.of());
        });
    }
