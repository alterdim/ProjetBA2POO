...
public class PlayerStateTest {
    ...
    private static List<Route> routesWithTotalLength(int length) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            routes.add(new Route("r" + i, s1, s2, 1, Route.Level.OVERGROUND, Color.ORANGE));
        }
    ...
    void playerStateWithClaimedRouteWorks() {
        ...
        var r1 = new Route("AT2_VAD_1", chMap.AT2, chMap.VAD, 1, Route.Level.UNDERGROUND, Color.RED);
        ...
        var r2 = new Route("BAL_OLT_1", chMap.BAL, chMap.OLT, 2, Route.Level.UNDERGROUND, Color.ORANGE);
        ...
        var r3 = new Route("DAV_AT3_1", chMap.DAV, chMap.AT3, 3, Route.Level.UNDERGROUND, null);
        ...
        var r4 = new Route("BRU_DAV_1", chMap.BRU, chMap.DAV, 4, Route.Level.UNDERGROUND, Color.BLUE);
...
/*assertThrows(IllegalArgumentException.class, ()->
                playerState.possibleAdditionalCards(1, iniCards*//*
         */
        /*, drawnCards*//*
         */
/*)
...
//        System.out.println(playerState.possibleAdditionalCards(iniCards.size(), iniCards, drawnCards));
    ...
    @Test
    void examplePossibleAdditionalCards(){
        var playerState = new PlayerState(SortedBag.of(), SortedBag.of(), List.of());
        ...
        playerState = playerState.withAddedCard(Card.LOCOMOTIVE);
        var c =playerState.possibleAdditionalCards(2, SortedBag.of(Card.GREEN));
